...
def rsl_rl_config(
  ...
  rl_config = config_dict.create(
      ...
      algorithm=config_dict.create(
          ...
          desired_kl=0.01,
          max_grad_norm=1.0,
          symmetry_config=config_dict.create()
      ),
  ...
  if env_name == "X02JoystickFlatTerrain":
    ...
    rl_config.algorithm.symmetry_config.use_data_augmentation = False
    rl_config.algorithm.symmetry_config.use_mirror_loss = True
    rl_config.algorithm.symmetry_config.data_augmentation_func = \
      "mujoco_playground.experimental.x02_walking.data_augmentation:get_symmetric_states_x02"
    rl_config.algorithm.symmetry_config.mirror_loss_coeff = 0.3
  return rl_config
